...
class PrometheusProxyControllerTest < ActionDispatch::IntegrationTest
  ...
  test "proxies requests when authenticated" do
    stub_request(:get, "http://upright-prometheus:9090/graph")
      .to_return(status: 200, body: "Prometheus UI")
  ...
  test "OTLP endpoint accepts valid token" do
    stub_request(:post, "http://upright-prometheus:9090/api/v1/otlp/v1/metrics")
